...
export default function GuideFormatsDeLogoPage() {
      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '64px 24px 100px' }}>
        ...
        <div style={{ marginBottom: '40px' }}>
          ...
          <h1 style={{
            ...
            Les formats de votre logo — SVG, PNG, PDF et plus
          </h1>
          <p style={{ fontFamily: FONT_BODY, fontSize: '15px', lineHeight: 1.8, color: '#5a554f', margin: 0, maxWidth: '600px' }}>
            Vous avez reçu votre logo en plusieurs formats. Chaque fichier a un rôle précis :
            web, impression, présentation, réseaux sociaux. Ce guide vous explique lequel
            utiliser selon la situation — plus jamais le mauvais fichier au mauvais endroit.
