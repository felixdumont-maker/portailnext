...
export default function GuideMetaAdsPage() {
      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '64px 24px 100px' }}>
        ...
        <div style={{ marginBottom: '40px' }}>
          ...
          <h1 style={{
            ...
            Meta Ads — Comprendre vos publicités
          </h1>
          <p style={{ fontFamily: FONT_BODY, fontSize: '15px', lineHeight: 1.8, color: '#5a554f', margin: 0, maxWidth: '600px' }}>
            Tout ce que vous devez savoir sur la publicité payante Facebook et Instagram :
            structure du compte, objectifs de campagne, ciblage, formats publicitaires,
            budget et lecture de vos résultats.
