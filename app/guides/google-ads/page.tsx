...
export default function GuideGoogleAdsPage() {
      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '64px 24px 100px' }}>
        ...
        <div style={{ marginBottom: '40px' }}>
          ...
          <h1 style={{
            ...
            Google Ads — Comprendre vos campagnes
          </h1>
          <p style={{ fontFamily: FONT_BODY, fontSize: '15px', lineHeight: 1.8, color: '#5a554f', margin: 0, maxWidth: '600px' }}>
            Tout ce que vous devez savoir sur la publicité Google : comment ça fonctionne,
            comment votre compte est structuré, comment lire vos résultats
            et comment collaborer efficacement avec notre équipe.
