...
export default function GuideAQuoiSertVotreSiteWebPage() {
      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '64px 24px 100px' }}>
        ...
        <div style={{ marginBottom: '40px' }}>
          ...
          <p style={{ fontFamily: FONT_BODY, fontSize: '15px', lineHeight: 1.8, color: '#5a554f', margin: 0, maxWidth: '600px' }}>
            Votre site web n&apos;est pas une brochure en ligne — c&apos;est votre seul actif numérique
            que vous possédez vraiment. Découvrez pourquoi il est le centre de toute votre
            stratégie numérique et comment en tirer le maximum.
